...
public class MockLogger<LoggerType1, LoggerType2> : MockLogger<LoggerType1>, ILogger<LoggerType2>
{
}

public class MockLogger<LoggerType> : ILogger<LoggerType>
{
    ...
    public Task WaitForMessageAsync(string expectedMessage)
        => WaitForMessageAsync(expectedMessage, TimeSpan.FromSeconds(5));
    public async Task WaitForMessageAsync(string expectedMessage, TimeSpan timeout)
    {
