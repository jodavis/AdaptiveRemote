...
internal class StaticCommandGroupProvider : IRemoteDefinitionService
{
    ...
    [
        ...
        [
            new TiVoCommand("ChannelUp", reverse: "ChannelDown", label: "Up", speakPhrase: Phrases.Conversation_Sent("Channel Up")),
            new TiVoCommand("ChannelDown", reverse: "ChannelUp", label: "Down", speakPhrase: Phrases.Conversation_Sent("Channel Down")),
            new IRCommand("VolumeUp", reverse: "VolumeDown", label: "Up", speakPhrase: Phrases.Conversation_Sent("Volume Up"), data: ""),
            new IRCommand("VolumeDown", reverse: "VolumeUp", label: "Down", speakPhrase: Phrases.Conversation_Sent("Volume Down"), data: "JgCgAI+SDxEPERARDhIPMg4yDxEOEg8yDjIPMQ8yDhEQEQ8RDxEPkRARDxIOEQ8SDxEOEg8RDzEPMg4yDzEPEg8xDzIOMg8RDxEPERARDjIPAAbyj5IPEQ8SDhEPEg8xDzIOEQ8SDzIOMg4yDzIOERARDxEPEQ+SDxEOEw4RDxIPEQ4SDxEPMQ8yDzEQMBARDzEPMg8xDxEPEg4SDxEPMQ8ADQU="),
        ...
        [
            ...
            new ApplicationCommand("Exit", speakPhrase: Phrases.Conversation_Goodbye)
        ])
    ]);
}
