...
class TestConventions:
    def test_all_seven_functions(self, tmp_path: Path) -> None:
        ...
        assert conventions.split_manifest_path(tmp_path, "train") == tmp_path / "train.json"
        assert conventions.split_manifest_path(tmp_path, "val") == tmp_path / "val.json"
        assert conventions.split_manifest_path(tmp_path, "test") == tmp_path / "test.json"
        ...
        assert conventions.model_path(tmp_path) == tmp_path / "speech_to_text_model.keras"
