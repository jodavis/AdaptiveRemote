...
class Manifest(Generic[S]):
    ...
    def __init__(self, samples: Sequence[S]) -> None:
        ...
        self._by_content_hash: dict[str, S] = {s.content_hash: s for s in self._samples}
