...
def main() -> None:
    parser = argparse.ArgumentParser(description="Add silence delays to WAV audio samples")
    ...
    stage = DelayAugmentor(
        ...
        prefix_vary_probability=params.add_delays.prefix_vary_probability,
        prefix_min_s=params.add_delays.prefix_min_s,
        prefix_max_s=params.add_delays.prefix_max_s,
        suffix_vary_probability=params.add_delays.suffix_vary_probability,
        suffix_min_s=params.add_delays.suffix_min_s,
        suffix_max_s=params.add_delays.suffix_max_s,
    )
