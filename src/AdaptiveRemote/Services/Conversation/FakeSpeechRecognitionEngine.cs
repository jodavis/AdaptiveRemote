...
internal class FakeSpeechRecognitionEngine : ISpeechRecognitionEngine
{
    ...
    void ISpeechRecognitionEngine.LoadGrammar(IGrammar grammar) => _grammars.Add(grammar.Name, grammar);
    void ISpeechRecognitionEngine.UnloadGrammar(IGrammar grammar) => _grammars.Remove(grammar.Name);
