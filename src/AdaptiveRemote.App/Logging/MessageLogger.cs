...
internal partial class MessageLogger
{
    ...
    [LoggerMessage(EventId = 1010, Level = LogLevel.Information, Message = "Cancelling in-progress learning to start learning {Command}")]
    public partial void BroadlinkCommandService_CancellingLearningForNewCommand(Models.Command command);
